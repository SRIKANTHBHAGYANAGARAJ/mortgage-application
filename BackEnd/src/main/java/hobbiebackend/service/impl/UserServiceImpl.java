...
import hobbiebackend.model.repository.AppClientRepository;
import hobbiebackend.model.repository.BusinessOwnerRepository;
import hobbiebackend.model.repository.UserRepository;
import hobbiebackend.service.UserRoleService;
...
public class UserServiceImpl implements UserService {
    ...
    public List<UserEntity> seedUsersAndUserRoles() {
        ...
        if (appClientRepository.count() == 0) {
            ...
            this.userRoleService.saveRole(userRoleEntity2);
        ...
        if (businessOwnerRepository.count() == 0) {
            ...
            business_user.setEmail("business@example.com");
