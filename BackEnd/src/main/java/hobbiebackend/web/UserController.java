...
import hobbiebackend.model.dto.UpdateAppClientDto;
import hobbiebackend.model.dto.UpdateBusinessDto;
...
import hobbiebackend.model.jwt.JwtRequest;
import hobbiebackend.model.jwt.JwtResponse;
import hobbiebackend.security.HobbieUserDetailsService;
import hobbiebackend.service.NotificationService;
import hobbiebackend.service.UserService;
...
public class UserController {
    ...
    public String logInUser(@RequestParam String username) {
        ...
        if (userByUsername.getRoles() != null && !userByUsername.getRoles().isEmpty()) {
            return userByUsername.getRoles().get(0).getRole().name();
        }
        return "USER";
    }
}